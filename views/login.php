...
<body class="bg-gray-50 flex min-h-screen">
    <!-- KIRI: GAMBAR & BRANDING (Hanya Muncul di Layar Besar) -->
    <div class="hidden lg:flex lg:w-1/2 bg-login-image relative">
        ...
        <div class="relative z-10 flex flex-col justify-between p-12 text-white w-full">
            ...
            <div class="flex items-center gap-3">
                <div
                    class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-purple-700 font-bold text-xl shadow-lg">
                    RW
                </div>
                <div>
    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 relative bg-white">
        ...
        <div class="w-full max-w-md mt-10 lg:mt-0">
            ...
            <div class="lg:hidden flex items-center gap-3 mb-8">
                <div
                    class="w-12 h-12 bg-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg">
                    RW
                </div>
                <div>
            ...
            <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl flex gap-3 items-start">
                ...
                <div>
                    ...
                    <p class="text-xs text-amber-700 mt-1 leading-relaxed">
                        Halaman ini khusus untuk Pengurus RW dan Ketua RT. Warga umum
