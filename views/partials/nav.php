                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            ...
                            <a href="/laporan"
                               class="<?= urlIs('/laporan') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Laporan Bulanan</a>
                        <?php endif ?>
                        <a href="/contact"
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <?php else : ?>
                        <div class="ml-3">
                            <a href="/register"
                            <a href="/login"
                               class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Masuk sebagai admin</a>
                        </div>
                    <?php endif ?>
                </div>
            </div>
