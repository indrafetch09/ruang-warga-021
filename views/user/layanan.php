...
<head>
    ...
    $description = "Fasilitas Balai RW 021 Bojong Nangka: gedung serbaguna, layanan Posyandu Bunga Tanjung, dan lapangan badminton indoor beserta jadwal serta koordinator layanan.";
...
<body class="bg-gray-50 flex flex-col min-h-screen text-gray-800">
    ...
    <!-- HERO + RINGKASAN FASILITAS (GABUNGAN SATU LAYAR) -->
    <section class="relative isolate overflow-hidden">
        <div class="absolute inset-0">
            <img src="/images/balairw21.jpg" alt="Gedung Balai Pertemuan RW 021" class="w-full h-full object-cover object-center"
                onerror="this.src='https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1600&q=80'" />
            <div class="absolute inset-0 bg-gradient-to-br bg-purple-950/85"></div>
        </div>
        ...
        <div class="relative items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 md:pb-12 md:min-h-[calc(100vh-6rem)] md:flex md:flex-col md:justify-center">
            ...
            <div class="max-w-3xl py-12">
                <h1 class="text-center my-14 text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
                    Balai RW 021 <span class="text-purple-700">&amp; Posyandu Bunga Tanjung</span>
                </h1>
                <p class="text-center mt-4 text-sm text-gray-200 leading-relaxed">
                    Pusat sarana publik terpadu RW 021 Bojong Nangka untuk kegiatan musyawarah warga, pelayanan kesehatan balita dan lansia, fasilitas olahraga bulutangkis indoor, serta pengajuan izin peminjaman gedung.
                </p>
            </div>

            <!-- SUMMARY STATS CARDS -->
            <div class="mt-10 md:mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                <div class="px-4 py-5 sm:px-5 sm:py-6 rounded-lg bg-white border border-purple-100 shadow-sm hover:shadow-md transition text-center">
                    <span class="block text-xl sm:text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">150 Orang</span>
                    <span class="mt-1.5 block text-[11px] sm:text-xs font-bold uppercase tracking-wider text-purple-700">Kapasitas Gedung</span>
                </div>
                <div class="px-4 py-5 sm:px-5 sm:py-6 rounded-lg bg-white border border-purple-100 shadow-sm hover:shadow-md transition text-center">
                    <span class="block text-xl sm:text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">Minggu Ke-4</span>
                    <span class="mt-1.5 block text-[11px] sm:text-xs font-bold uppercase tracking-wider text-purple-700">Jadwal Posyandu</span>
                </div>
                <div class="px-4 py-5 sm:px-5 sm:py-6 rounded-lg bg-white border border-purple-100 shadow-sm hover:shadow-md transition text-center">
                    <span class="block text-xl sm:text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">5 Klub PB</span>
                    <span class="mt-1.5 block text-[11px] sm:text-xs font-bold uppercase tracking-wider text-purple-700">Badminton Indoor</span>
                </div>
                <div class="px-4 py-5 sm:px-5 sm:py-6 rounded-lg bg-white border border-purple-100 shadow-sm hover:shadow-md transition text-center">
                    <span class="block text-xl sm:text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">WhatsApp</span>
                    <span class="mt-1.5 block text-[11px] sm:text-xs font-bold uppercase tracking-wider text-purple-700">Izin Peminjaman</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="py-14 md:py-20 flex-1">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14 md:space-y-16">
            ...
            <?php
            $galeriBalai = [
                ['foto' => '/images/aula_posyandu.jpg', 'judul' => 'Pelayanan Posyandu Bunga Tanjung', 'sub' => 'Kesehatan Balita & Lansia', 'grid' => 'lead'],
                ['foto' => '/images/aula_rapat.jpg', 'judul' => 'Musyawarah & Rapat Warga', 'sub' => 'Pertemuan Rutin RW 021', 'grid' => 'wide'],
                ['foto' => '/images/aula_badminton.jpg', 'judul' => 'Lapangan Badminton Indoor', 'sub' => 'Olahraga & Kebersamaan', 'grid' => 'tile'],
                ['foto' => '/images/aula_senam.jpg', 'judul' => 'Senam Kebugaran Jasmani', 'sub' => 'Kebugaran Mingguan', 'grid' => 'tile'],
                ['foto' => 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=800&q=80', 'judul' => 'Gedung Pertemuan Serbaguna', 'sub' => 'Fasilitas Peminjaman Acara', 'grid' => 'wide'],
                ['foto' => '/images/masjid.jpg', 'judul' => 'Musala & Sarana Ibadah', 'sub' => 'Sarana Ibadah Warga', 'grid' => 'wide'],
            ];
            ...
            $fotoCadangan = 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=800&q=80';
            ?>

            <section id="balai-rw" class="p-6 md:p-10 space-y-8">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-lg border border-purple-100 shadow-sm flex flex-col justify-between space-y-5 hover:shadow-md hover:border-purple-200 transition">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 mt-2 leading-relaxed">
                                Pelayanan kesehatan gratis ibu, balita, dan lansia. Menyediakan penimbangan berat badan, imunisasi dasar, vitamin A, makanan tambahan (PMT), serta cek tensi darah dan kadar gula rutin bagi warga usia lanjut.
                            </p>
                        </div>
                        <div class="space-y-1.5 pt-2 border-t border-gray-100 text-xs text-gray-600">
                            <div class="flex items-center gap-2">
    ...
    <div id="detail-modal" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
            ...
            <div class="p-6 overflow-y-auto space-y-6 flex-1 text-gray-800">
                ...
                <div class="pt-2">
                    <a id="modal-wa-btn" href="#" target="_blank" rel="noopener noreferrer" class="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-lg flex items-center justify-center gap-2 transition shadow-md">
        ...
        const modalData = {
            'peminjaman-balai': {
                ...
                requirements: [
                    ...
                    'Menghubungi Sekretaris RW lebih dulu via WhatsApp',
            ...
            'posyandu-info': {
                ...
                headerBg: 'bg-purple-700',
                description: 'Pusat pelayanan kesehatan ibu, balita, dan lansia rutin yang diselenggarakan oleh kader Posyandu Bunga Tanjung RW 021.',
                subitems: [
