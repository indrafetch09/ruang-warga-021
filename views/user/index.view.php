    ...
    <div class="bg-white py-16 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <div class="text-center max-w-3xl mx-auto">
                <span class="text-xs font-bold uppercase tracking-wider text-purple-600 bg-purple-50 px-3 py-1.5 rounded-full border border-purple-200">Profil Lingkungan</span>
                <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight mt-3">
                    Visi & Misi <span class="text-purple-600">RW 021</span>
                </h2>
                <p class="text-sm text-gray-500 mt-2">
                    Landasan komitmen bersama demi kemajuan, keamanan, dan keharmonisan warga lingkungan RW 021.
                </p>
            </div>
                ...
                <div id="content-visi" class="flex flex-col md:flex-row gap-8 items-start">
                    <div class="w-full md:w-1/3">
                        ...
                        <p class="text-sm text-gray-500 leading-relaxed">
                            Cita-cita dan arah bersama bagi masa depan seluruh warga di lingkungan RW 021.
                        </p>
                    </div>
