        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
                ...
                <div class="bg-white rounded-b-lg rounded-tr-lg p-6 md:p-10 shadow-sm border border-gray-200 relative overflow-hidden">
                    ...
                    <div id="content-visi" class="flex flex-col md:flex-row gap-8 items-start">
                        <div class="w-full md:w-1/3">
                            ...
                            <p class="text-sm text-gray-500 leading-relaxed">
                                Komitmen dan cita-cita luhur bagi seluruh warga lingkungan RW 021.
                            </p>
                        </div>
                        <div class="w-full md:w-2/3">
                            <div class="bg-purple-50/60 border border-purple-100 p-6 md:p-8 rounded-lg hover:border-purple-300 transition-all">
                    ...
                    <div id="content-misi" class="hidden flex flex-col md:flex-row gap-8 items-start">
                        <div class="w-full md:w-1/3">
                            ...
                            <p class="text-sm text-gray-500 leading-relaxed">
                                Langkah nyata dan program kerja terpadu untuk merealisasikan visi lingkungan RW 021.
                            </p>
                        </div>
                        <div class="w-full md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <!-- Misi 5 -->
                            <div class="bg-emerald-50/60 border border-emerald-100 p-6 rounded-lg hover:border-emerald-300 transition-all md:col-span-2">
                                <div class="w-12 h-12 bg-emerald-600 text-white rounded-lg flex items-center justify-center mb-4 shadow-sm">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:items-center gap-4 border-b border-gray-100 pt-8">
                <div>
                    ...
                    <p class="text-xs text-center md:text-lg text-gray-500 mt-1">Pemetaan wilayah terpadu dan Landmarking RW 021 Bojong Nangka.</p>
                </div>
            </div>

            <!-- GIS Maps RW 021 -->
            <div class="overflow-hidden border border-gray-200 bg-gray-100">
                <div class="w-full sm:h-100 md:h-260 lg:h-[750px]">
                    <img src="/images/mapsRw21.jpg" alt="Peta GIS Wilayah RW 021" class="w-full h-full object-cover object-center" />
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 md:p-10 shadow-sm border border-gray-200 space-y-6">
                <div class="flex flex-col md:flex-row justify-center items-center md:items-center gap-4 border-b border-gray-100 pb-4">
                    <div>
