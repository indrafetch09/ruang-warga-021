...
<head>
    <?php $title = "Profile RW 021 - Ruang Warga 021";
...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <div class="py-16 md:py-20 bg-gray-50 flex-1">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <!-- SIMPLE PAGE HEADER -->
            <div class="flex flex-col md:flex-row justify-center items-start md:items-center gap-4">
                <div class="space-y-2">
            ...
            <div class="space-y-10">
                ...
                <!-- MAP PERSEGI TANPA KONTAINER: DI ATAS KARTU DESKRIPSI -->
                <div class="relative overflow-hidden">
                    <img src="/images/maps_rw21.jpg" alt="Peta Wilayah RW 021 Dasana Indah, Bojong Nangka" class="w-full h-[280px] md:h-[400px] object-cover" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
                    <div class="w-full h-[280px] md:h-[400px] items-center justify-center flex-col gap-4 bg-gray-100 text-gray-400" style="display:none;">
