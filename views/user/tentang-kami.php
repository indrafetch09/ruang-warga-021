...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <div class="py-16 md:py-20 bg-gray-50 flex-1">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div>
                <div class="flex flex-col md:flex-row justify-center items-start md:items-center gap-4 border-b border-gray-100 pb-4">
                    <div>
                        <h2 class="text-2xl mt-20 mb-5 md:text-3xl font-extrabold text-gray-900">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 m-12">
            ...
            <div>
                <div class="flex flex-col flex-row justify-center items-center gap-4 py-8">
                    <div>
                ...
                <div class="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-gray-200 space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg border border-gray-200 p-5 max-w-3xl mx-auto shadow-sm">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-gray-900 mb-3">Catatan Penting</h4>
