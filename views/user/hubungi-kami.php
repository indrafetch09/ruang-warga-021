...
<head>
    <?php $title = "Hubungi Kami - Ruang Warga 021";
...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <div class="py-10 bg-white flex-1">
        <div class="flex bg-white justify-center items-center pb-4">
            <div>
                <h2 class="mt-12 mb-5 text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900">
                    Lokasi <span class="text-purple-600"> Sekretariat RW 021</span>
                </h2>
            </div>
        </div>
    ...
    <div class="py-12 md:py-16 bg-white flex-1">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div class=" lg:grid-cols-2 gap-4 items-start">
    ...
    <!-- END MAIN CONTENT - CONTACT CARDS -->
