        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-6 bg-purple-50/60 rounded-2xl border border-purple-100 flex flex-col justify-between">
                    ...
                    <a href="https://maps.google.com/?q=Aula+RW+021+Bojong+Nangka" target="_blank" class="w-full py-2.5 bg-purple-700 hover:bg-purple-800 text-white text-xs font-bold rounded-xl transition text-center flex items-center justify-center gap-1.5 shadow-sm">
            ...
            <div class="bg-white p-4 rounded-2xl border border-gray-200 shadow-md">
                <div class="w-full h-[500px] rounded-xl overflow-hidden shadow-inner">
                    <iframe
