    ...
    <div class="py-10 flex-1">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                <div>
                    <!-- Link ini bisa diarahkan ke halaman list pengumuman versi admin nantinya -->
                    <a href="/dashboard"
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Buat informasi penting atau pemberitahuan terbaru untuk
                        ditampilkan di portal warga.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <form action="#" method="POST">
                    ...
                    <div class="p-6 md:p-8 border-b border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Judul Pengumuman
                                    <span class="text-rose-500">*</span></label>
                                <input type="text" placeholder="Contoh: Pemadaman Listrik Bergilir"
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Publikasi
                                    <span class="text-rose-500">*</span></label>
                                <input type="date"
                    ...
                    <div class="p-6 md:p-8 border-b border-gray-100">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Pesan Lengkap <span
                                    class="text-rose-500">*</span></label>
                            <p class="text-xs text-gray-500 mb-2">
                                Tuliskan pesan dengan jelas dan singkat agar mudah dibaca oleh
                                warga di halaman utama.
                            </p>
                            <textarea rows="6"
                                placeholder="Sehubungan dengan perbaikan gardu induk PLN, akan dilakukan pemadaman listrik pada pukul..."
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition text-sm resize-none"
                                required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" placeholder="Contoh: Baca selengkapnya"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Tautan / URL</label>
