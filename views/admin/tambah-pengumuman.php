...
<head>
    <?php $title = "Tambah Pengumuman - Dasbor Pengurus RW 021";
    ...
    <div class="flex flex-1 max-w-[1400px] w-full mx-auto relative">
        ...
        <main class="flex-1 w-full min-w-0 p-4 sm:p-6 lg:p-8 space-y-6">
            ...
            <?php if (!empty($flashError)): ?>
                <div class="p-4 bg-red-50 border border-red-200 rounded-xl text-xs text-red-600 font-semibold max-w-4xl mx-auto mb-4 flex items-center gap-2">
